...
# Prompt B clearly defines the role, task, audience and constraints,
# making it easier for the AI to understand the objective.

# Your answer (Reason 2):
# Prompt B provides step-by-step instructions, which helps the AI
# produce a more structured and focused response.

# Q8c: What is ONE strength of the prompt you did NOT choose?
# Your answer:
# Prompt A provides more business context and background information,
# which helps the AI better understand the situation.
...
# Explanation:
# I borrowed the additional business context from Prompt A and added it
# to Prompt B. This provides the AI with more background information
# while retaining the clear structure, role definition and constraints
# that make Prompt B effective.




This answer shows that you understand:
...
which is exactly what NTU is trying to test in Q8.
